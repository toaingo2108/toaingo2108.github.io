  ...
  <div class="container">
    <div class="profile">
      ...
      <div class="profile__text">
        <h1
          ...
          :class="xs ? 'text-h3' : 'text-h2'"
        >
          {{ profile.fullName }}
        </h1>
        <h2
          class="text-h5 text-uppercase font-weight-light mt-5 text-deep-purple-lighten-1"
        >
          {{ profile.position }}
        </h2>
      </div>
    ...
    <div class="block">
      <div class="block__row" :class="mdAndDown ? 'flex-column' : undefined">
        <div
          class="block__element block__element-1"
          :class="xs ? 'flex-column' : undefined"
        >
